...
$colors_string = implode("@", $numbers_array);
echo "<br>" . $colors_string . "<br>";
...
if ($a == $b) {
    echo $a . " та " . $b . " рівні без приведення типів<br>";
} else {
    echo $a . " та " . $b . " не рівні без приведення типів<br>";
}

// Порівняння змінних з приведенням типів
if ($a !== $b) {
    echo $a . " та " . $b . " не рівні з приведенням типів<br>";
} else {
    echo $a . " та " . $b . " рівні з приведенням типів<br>";
}
