        ...
        <div class="box">
            <div class="block-1">
                <div class="landing-main-text">
                    ...
                    <a href="index.php?page=diviation-page">
                ...
                <div class="img1-landing"><img src="images/landing1.png" alt=""></div>    
            </div>

            <div class="block-2">
                <h1>Ми пропонуємо:</h1>
                <div class="bl2-images">
                    <a href="index.php?page=all-cards">
                        <div class="bl2-bl1">
                            <img src="images/landing2.png" alt="">
                            <h2>Трактування колоди Райдера-Уейта</h2>
                        </div>
                    </a>
                    <a href="index.php?page=interpretation-page">
                        <div class="bl2-bl2">
            ...
            <div class="block-3">
                ...
                <a href="index.php?page=tarot-deck">
